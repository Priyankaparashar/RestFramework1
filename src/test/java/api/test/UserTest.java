...
public class UserTest {
	...
	public void testgetRequest() {
		...
		Response response= UserEndpoints.getUser(this.userpojo.getUsername());
	...
	public void testputRequest() {
		...
		Response response =  UserEndpoints.updateUser(userpojo, this.userpojo.getUsername());
		
		response.then().log().body();
		Assert.assertEquals(response.getStatusCode(), 200);
		
		Response afterResponse= UserEndpoints.getUser(this.userpojo.getUsername());
